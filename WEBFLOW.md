...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/joshmarketingnl/jbstone-dealerkaart@v1.0.2/dist/jbstone-map.min.css"/>
<script src="https://cdn.jsdelivr.net/gh/joshmarketingnl/jbstone-dealerkaart@v1.0.2/dist/jbstone-map.min.js" defer></script>
```

Page-level, niet site-wide (alleen deze pagina heeft de kaart nodig). Bij een nieuwe release: het versienummer `@v1.0.2` in beide jsDelivr-URL's ophogen.
